...
public class CopyRightPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("\n\n   \n   No part of this software may reproduced , in whole \nor without the specific return permission of the owner.\n \n        The software is developed by Ms.Farnas.");
        ...
        jPanel2.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 590, 90, 30));

        jButton1.setBackground(new java.awt.Color(0, 102, 102));
        jPanel2.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 580, 120, 50));

        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(-120, 0, 1940, 870));
